if (document.readyState == 'loading') {
  ...
  function ready() {
    ...
    const addToCartButtons = document.getElementsByClassName("add_cart")
  ...
  function addProductToCart(event) {
    ...
    const productImage = productInfos.getElementsByClassName("modal-img")[0].src
    const productName = productInfos.getElementsByClassName("modal-title")[0].innerText
    const productPrice = productInfos.getElementsByClassName("modal-preco")[0].innerText
